...
def main():
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        for step in range(num_batch): # tqdm(range(num_batch), total=num_batch, ncols=70, leave=False, unit='b'):
            ...
            writer.add_scalar('Train/Loss', loss.item(), (epoch - 1) * num_batch + step)
        ...
        writer.add_scalar('Valid/NDCG@10', t_valid[0], epoch)
        writer.add_scalar('Valid/HR@10', t_valid[1], epoch)
        writer.add_scalar('Test/NDCG@10', t_test[0], epoch)
        writer.add_scalar('Test/HR@10', t_test[1], epoch)
