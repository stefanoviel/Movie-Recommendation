...
movies = pd.read_csv('data_model/movies.csv')
...
args_path = 'data_model/args.txt'
model_path = 'data_model/SASRec.epoch=30.lr=0.001.layer=2.head=1.hidden=50.maxlen=200.pth'
